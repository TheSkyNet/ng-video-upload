...
`<div class="video-container">
  <div class="match-parent" [ngSwitch]="status">
    ...
    <div class="match-parent" *ngSwitchCase="statusEnum.NotSelected">
      <button type="button" class="add-video-btn" (click)="onVideoClicked($event)">
          <div>
            <p class="plus">+</p>
    ...
    <div class="selected-status-wrapper match-parent" *ngSwitchCase="statusEnum.Loaded">
      <img [src]="videoThumbnail" #videoElement>

      <button type="button" class="remove" (click)="removeVideo()">×</button>
    </div>
    ...
    <div *ngSwitchCase="statusEnum.Uploading">
      <img [attr.src]="videoThumbnail ? videoThumbnail : null" (click)="onVideoClicked()">
